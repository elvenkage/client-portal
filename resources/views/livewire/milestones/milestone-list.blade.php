            ...
            <form wire:submit="save" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea wire:model="description" id="ms-description" rows="2"
                        class="mt-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"></textarea>
            ...
            <div class="flex items-start justify-between">
                ...
                @if($milestone->status !== 'completed')
                    <button wire:click="completeMilestone({{ $milestone->id }})"
                        ...
                        class="ml-4 rounded-md bg-green-50 px-2.5 py-1.5 text-xs font-semibold text-green-700 shadow-sm hover:bg-green-100 transition-colors">
                        ✓ Complete
                    </button>
                @endif
            </div>
